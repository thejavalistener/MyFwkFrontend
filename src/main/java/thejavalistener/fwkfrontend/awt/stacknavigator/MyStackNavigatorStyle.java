package thejavalistener.fwkfrontend.awt.stacknavigator;

import java.awt.Color;

public class MyStackNavigatorStyle
{
	public Color foreground = new Color(120,120,120);
	...
	public Color disabled = Color.LIGHT_GRAY;
