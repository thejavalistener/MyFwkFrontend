...
public class MyDialogTest
{
	...
	{
		ReturnablePanelImple rp=new ReturnablePanelImple();
	...
	static class ReturnablePanelImple extends JPanel implements ReturnablePanel
	{
		private Object returnValue=null;
		private MyDialog dlg;

		public ReturnablePanelImple()
		{
